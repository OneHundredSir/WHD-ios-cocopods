...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/OneHundredSir/Cocopods/tree/master/OC/WHDcolor"
 ...
 # s.license      = "MIT (example)"
  ...
  s.source       = { :git => "https://github.com/OneHundredSir/Cocopods/tree/master/OC/WHDcolor", :tag => "1.0.0" }
